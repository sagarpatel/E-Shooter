...
namespace E_Shooter
{
    public class Level_1_5 : ScreenAbstract
    {
        ...
        public Level_1_5(Game game, SpriteBatch givenSpriteBatch): base(game, givenSpriteBatch)
        {
            ...
            enemyBase1 = new EnemyBaseObject(game, givenSpriteBatch, 3, 0.8f);
            collisionList.Add(enemyBase1);

            enemyBase2 = new EnemyBaseObject(game, givenSpriteBatch, 3, 0.8f);
            collisionList.Add(enemyBase2);


            enemyBase3 = new EnemyBaseObject(game, givenSpriteBatch, 3, 0.8f);
            collisionList.Add(enemyBase3);

            enemyBase4 = new EnemyBaseObject(game, givenSpriteBatch, 3, 0.8f);
            collisionList.Add(enemyBase4);

            enemyBase5 = new EnemyBaseObject(game, givenSpriteBatch, 4, 0.8f);
