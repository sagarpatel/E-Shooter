...
namespace E_Shooter
{
    public class Level_2_3 : ScreenAbstract
    {
        ...
        public Level_2_3(Game game, SpriteBatch givenSpriteBatch): base(game, givenSpriteBatch)
        {
        ...
        public override void setInitialValues()
        {
            ...
            movingEnemyBase2.spawnConeArc = 120;
